...
auto_match_finder = AutoMatchFinder(
        attack_btn_path = r"A:\Projects\Coc_VisionBot\templates\Home_Village\Attack_Icon\attack_1.png",
        find_match_btn_path = r"A:\Projects\Coc_VisionBot\templates\Find_a_Match.png",
        next_btn_img_path = r"A:\Projects\Coc_VisionBot\templates\next.png",
        target_judge_func = target_judge_func
    )

    # 2. 配置撒兵类
clicker = AutoClickerInRectRegion(
        btn_img_path=r"A:\Projects\Coc_VisionBot\templates\dragon.png",
        region_yaml_path='A:\\Projects\\Coc_VisionBot\\config\\regions.yaml',
...
return_home_btn_path = r"A:\Projects\Coc_VisionBot\templates\return_village\return_home_village.png"
